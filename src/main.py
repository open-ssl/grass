...
def generate_error_report(driver):
    ...
    print(response.text)
    print(
        "Error report generated! Provide the above information to the developer for debugging purposes."
    )
...
def get():
    try:
        network_quality = driver.find_element(
            "xpath", '//*[contains(text(), "Network quality")]'
        ).text
